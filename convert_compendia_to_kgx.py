...
import click
import jsonschema
from node_normalizer import util, redis_adapter
...
def validate(in_file):
    ...
    json_schema = Path(__file__).parent / "node_normalizer" / "resources" / "valid_compendium_data_format.json"
